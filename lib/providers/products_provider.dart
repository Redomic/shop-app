...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    final url = Uri.parse(
        'https://shop-app-3be3b-default-rtdb.asia-southeast1.firebasedatabase.app/products.json?auth=$authToken&$filterString');
    try {
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.parse(
        'https://shop-app-3be3b-default-rtdb.asia-southeast1.firebasedatabase.app/products.json?auth=$authToken');
